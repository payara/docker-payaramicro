...
RUN wget --no-verbose -O ${PAYARA_HOME}/payara-micro.jar https://central.maven.org/maven2/fish/payara/extras/payara-micro/${PAYARA_VERSION}/payara-micro-${PAYARA_VERSION}.jar
